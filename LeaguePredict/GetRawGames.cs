...
{
    internal static class GetRawGames
    {
        ...
        {
            string getstr = "https://na.api.riotgames.com/api/lol/NA/v1.3/game/by-summoner/" + playerId +
        ...
        public static List<string> GetUserIDs(int min = 57067600, int max = 57467600)
        {
            ...
            for (int i = min; i < max; i++)
            {
                ...
                string getstr = "https://na.api.riotgames.com/api/lol/NA/v1.4/summoner/" + getIds + "?api_key=" +
                                apiKey;
                string rawdata;
                try
                {
